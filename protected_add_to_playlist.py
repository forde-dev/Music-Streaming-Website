        ...
        if 'sid' in cookie:
            ...
            if session_store.get('authenticated'):
                ...
                try:
                    ...
                    cursor.execute("""INSERT INTO playlists (username, playlist_name, song_id) VALUES (%s, %s, %s)""", (username, playlist, song_id))
                    connection.commit()
                    result = '<p>Song successfully added to %s</p>' % playlist
                    cursor.close()
                    connection.close()
                except db.Error:
                ...
                page = """
                    <main>
                        %s
                        <p>
                            <a href="protected_library.py">Show playlist</a>
                            <a href="protected_streaming.py">Return Back to Browse</a>
                        </p>
                    </main>
                    <aside>
                    </aside>""" % (result)
